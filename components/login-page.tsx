...
<div className="text-center mt-6">
  <a href="https://www.iubenda.com/privacy-policy/65370946" target="_blank" rel="noopener noreferrer" className="text-xs text-gray-400 hover:text-gray-600 underline">Privacy Policy
  </a>
</div>
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
